...
// TODO: Define a protocol `Describable`
...
// TODO: Implement a struct `Book` that conforms to `Describable`
...
// TODO: Define a protocol `Messagable` and create conforming types (`TextMessage`, `ImageMessage`)
...
// TODO: Create `NewBook` conforming to `Describable` using a computed property for `description`
